...
public class DropBoxHandler {
	public static void createDropBoxes()
	{
		...
		Screen.dropBox[2] = new DropBox(10, 10, 400, 50, Color.white, Color.black); //For set options for sealed play
		Screen.dropBox[3] = new DropBox(10, 10, 400, 50, Color.white, Color.black);//For deck options for card Editor
		Screen.dropBox[4] = new DropBox(10, 60, 400, 50, Color.white, Color.black);//For set options for card editor
